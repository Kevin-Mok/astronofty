...
class SellNFT extends React.Component {
    ...
    // const [numUpload, updateNumUpload] = useState(1);
    // const [uploadChildren, updateUploadChildren] = useState([]);
  ...
  constructor(props) {
    ...
    // TODO: figure out how to update nested object
    // onAddUpload = () => {
      // updateNumUpload(numUpload + 1)
      // updateFiles(prevFiles => ({
        // let files = { ...prevFiles.files }
        // files[fileObj["num"]] = {
          // ...prevFiles.files[fileObj["num"]],
          // name: fileObj["name"],
          // file: fileObj["file"]
        // }
      // // updateFiles(prevFiles => ({
  ...
  uploadChildCallback = (fileObj) => {
    ...
    // uploadChildCallback = (fileObj) => {
      // updateFiles(prevFiles => ({
        // let files = { ...prevFiles.files }
        // files[fileObj["num"]] = {
          // ...prevFiles.files[progressObj.num],
    ...
    return (
        ...
        <div className="flex flex-col place-items-center mt-10" id="nftForm">
            ...
            <h3 className="text-center font-bold text-purple-500 mb-8">Upload your NFT to the marketplace</h3>
              ...
              focus:shadow-outline" id="name" type="text"
              placeholder="Axie#4563" onChange={e =>
                {
      ...
      name: e.target.value
              ...
              value={this.state.name}></input>
                ...
                <div className="mb-6">
                    ...
                    <textarea className="shadow
                  appearance-none border rounded w-full py-2
              px-3 text-gray-700 leading-tight
                  focus:outline-none focus:shadow-outline"
                  cols="40" rows="5" id="description"
                  type="text" placeholder="Axie Infinity
                  Collection" value={this.state.description}
                  onChange={e =>
    this.setState({ 
      name: e.target.value
    })}
...
<button onClick={this.onAddUpload}>
  Add File
</button>
